...
//        var key = user_live.value?.friendRequest?.keys?.elementAt(position)
//        var email = user_live.value?.friendRequest?.get(key)
//        user_live.value?.friendList!!.put(key.toString(), email.toString())
//        user_live.value?.friendRequest!!.remove(key)
//
